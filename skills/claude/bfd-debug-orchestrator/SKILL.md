...
1. `bfd-project-init`
2. `bfd-flash-programmer`
3. `bfd-rtt-logger`
4. `bfd-debug-interface`
5. `bfd-debug-executor`
6. `bfd-register-capture`
7. `bfd-fault-logger`
...
- Save all artifacts under `logs/` or `.claude/debug/`.
...
- `.claude/skills/bfd-debug-orchestrator/references/hardfault_record_template.md`
- `.claude/skills/bfd-debug-orchestrator/references/error_evolution_schema.md`
- `.claude/skills/bfd-debug-orchestrator/references/token_saving_output_rules.md`
- `.claude/skills/bfd-debug-orchestrator/resources/README.md`
- `.claude/skills/bfd-debug-orchestrator/resources/f4/debug_fault_template.h`
- `.claude/skills/bfd-debug-orchestrator/resources/f4/debug_fault_template.c`
